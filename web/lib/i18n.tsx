...
const DICT = {
  ru: {
    ...
    watchlist_subtitle: "Тикеры, проверенные через Telegram-бота (/add) или добавленные здесь — тот же вердикт BUY/WAIT/PASS, тот же анализ.",
    watchlist_ticker_placeholder: "Тикер, напр. NVDA",
    watchlist_add_button: "Добавить в список",
    watchlist_checking: "Проверяем…",
    watchlist_empty: "Пока ничего не добавлено. Отправьте /add TICKER боту в Telegram или добавьте тикер здесь.",
  ...
  en: {
    ...
    watchlist_subtitle: "Tickers checked via the Telegram bot (/add) or added here — same BUY/WAIT/PASS verdict, same analysis.",
    watchlist_ticker_placeholder: "Ticker, e.g. NVDA",
    watchlist_add_button: "Add to watchlist",
    watchlist_checking: "Checking…",
    watchlist_empty: "Nothing added yet. Send /add TICKER to the Telegram bot, or add a ticker here.",
