...
const DICT = {
  ru: {
    ...
    updated: "обновлено",
    logout: "Выйти",
    nav_watchlist: "Список наблюдения",
    nav_dashboard: "← Дашборд",

    watchlist_title: "Список наблюдения",
    watchlist_subtitle: "Тикеры со статусом WAIT — стоит последить. Один тикер = последняя проверка. BUY и PASS отправляются в Telegram, но не остаются в этом списке.",
    watchlist_ticker_placeholder: "Тикер, напр. NVDA",
    watchlist_add_button: "Добавить в список",
    watchlist_checking: "Проверяем…",
    watchlist_empty: "Нет тикеров со статусом WAIT прямо сейчас. Отправьте /add TICKER боту в Telegram или добавьте тикер здесь.",
    watchlist_error_invalid: "Некорректный тикер.",
    watchlist_error_failed: "Проверка не удалась",
    watchlist_fallback_levels: "формула, не собственный план модели",
    watchlist_no_db: "Не удалось загрузить список наблюдения.",
    th_verdict: "Вердикт",
    th_conviction: "Убедительность",
    th_checked: "Проверено",
    verdict_buy: "BUY",
    verdict_wait: "WAIT",
    verdict_pass: "PASS",
  ...
  en: {
    ...
    watchlist_subtitle: "Tickers currently WAIT — worth watching. One row per ticker (latest check wins). BUY and PASS results are sent to Telegram but don't stay listed here.",
    watchlist_ticker_placeholder: "Ticker, e.g. NVDA",
    watchlist_add_button: "Add to watchlist",
    watchlist_checking: "Checking…",
    watchlist_empty: "No WAIT tickers right now. Send /add TICKER to the Telegram bot, or add a ticker here.",
    watchlist_error_invalid: "Invalid ticker.",
    watchlist_error_failed: "Check failed",
    watchlist_fallback_levels: "formula fallback, not the model's own plan",
    watchlist_no_db: "Couldn't load the watchlist.",
    th_verdict: "Verdict",
    th_conviction: "Conviction",
    th_checked: "Checked",
    verdict_buy: "BUY",
    verdict_wait: "WAIT",
    verdict_pass: "PASS",
