  ...
  return (
    <main className="container">
      ...
      <div className="disclaimer-banner">
        ⚠ Это не финансовая консультация. Вся информация на этой странице — результат
        автоматического скрининга и носит образовательный характер. Скринер — это
        фильтр, а не сигнал к действию; ни один тикер не является рекомендацией
        купить или продать. Проведите собственное исследование (DYOR), проверьте
        халяльность самостоятельно и проконсультируйтесь с независимым финансовым
        консультантом перед принятием решений. Торговля акциями связана с риском
        потери капитала.
      </div>
