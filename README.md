...
| 4 | `technicals` | Day 3 | EMA stack, RS pctile, RSI 40–80, VDU, pivot, ATR stops |
...
| 7 | `ranking` | — | hard gates (EMA200, halal, R/R≥3, vision≠F) → weighted composite |
...
- R/R < 3:1, halal FAIL, below EMA200, vision grade F → hard rejection.
