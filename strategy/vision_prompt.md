...
volume bars and 50-day volume MA, plus a small numeric context block.
...
B = good structure, one flaw (slightly extended, no VDU, base 3). C = tradable only in an
aggressive regime, multiple flaws. F = wrong stage/trend, broken structure, or no plan.
